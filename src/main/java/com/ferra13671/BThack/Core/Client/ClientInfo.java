...
public final class ClientInfo implements Mc {
    ...
    private final GLTexture defaultMainMenuImage = GLTexture.fromPath("assets/bthack/textures/bthack_mainmenu.jpg", PathMode.INSIDEJAR, GLTexture.ColorMode.RGBA);
