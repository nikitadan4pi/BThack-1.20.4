package com.nikitadan4pi.BThack.api.Gui.ClickGui;
...
import com.nikitadan4pi.BThack.api.Gui.Config.LoadConfigScreen;
...
import com.nikitadan4pi.BThack.api.Utils.System.buttons.SliderButton;
import com.nikitadan4pi.BThack.api.Utils.System.buttons.TextFrameButton;
    ...
    public void render(DrawContext guiGraphics, int mouseX, int mouseY, float partialTicks) {
        ...
        if (descriptionModule.get() != null) {
            if (descriptionModule.get() instanceof PluginModule pluginMod) {
                ...
                BThackRender.drawRect(1, ClickGuiScreen.descriptionY - 17, length, (ClickGuiScreen.descriptionY + 12), ColorUtils.fastRGBA(ClickGui.BACKGROUND_COLOR));
                BThackRender.drawOutlineRect(1, ClickGuiScreen.descriptionY - 17, length, (ClickGuiScreen.descriptionY + 12), 1, rainbow);
                BThackRender.drawString(descriptionModule.get().getDescription(), 6, (ClickGuiScreen.descriptionY - 1), ClickGui.fontColor.getValue().getRGB(), false);
                BThackRender.drawString("Plugin: " + pluginMod.plugin.pluginName, 6, (ClickGuiScreen.descriptionY - 12), ClickGui.fontColor.getValue().getRGB());
            } else {
                int length = mc.textRenderer.getWidth(descriptionModule.get().getDescription()) + 10;
                BThackRender.drawRect(1, ClickGuiScreen.descriptionY - 5, length, (ClickGuiScreen.descriptionY + 12), ColorUtils.fastRGBA(ClickGui.BACKGROUND_COLOR));
                BThackRender.drawOutlineRect(1, ClickGuiScreen.descriptionY - 5, length, (ClickGuiScreen.descriptionY + 12), 1, rainbow);
                BThackRender.drawString(descriptionModule.get().getDescription(), 6, (ClickGuiScreen.descriptionY - 1), ClickGui.fontColor.getValue().getRGB());
            }
        }
